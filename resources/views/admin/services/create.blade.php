            ...
            <div style="display: grid; grid-template-columns: 3fr 1fr; gap: 30px; align-items: start;">
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div>
                        ...
                        <textarea name="summary" rows="3" placeholder="Tóm tắt ngắn gọn dịch vụ..."
                            style="width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 15px; box-sizing: border-box; resize: vertical;"></textarea>
                    </div>

                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #475569;">Nội dung chi tiết (Quy trình, thiết bị...)</label>
                        <textarea id="editor" name="description"
                            style="width: 100%; min-height: 250px; border: 1px solid #cbd5e1; border-radius: 8px; box-sizing: border-box;"></textarea>
                    </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <div style="background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
                        <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #475569;">Hình ảnh đại diện</label>
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-floppy-disk" style="margin-right: 5px;"></i> LƯU DỊCH VỤ
                    </button>
                </div>
            </div>
        </form>
